...
"""
PyInstaller spec file for the Eyes desktop application.
Produces a one-folder distribution (onedir) that honours
%APPDATA%\\eyes\\ paths instead of the frozen-app sandbox.
...
from PyInstaller.building.make_bundle import EXECUTABLE, PKG
