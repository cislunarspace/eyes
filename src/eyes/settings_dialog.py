...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._yaw_slider.setMinimum(5)
        self._yaw_slider.setMaximum(30)
        self._yaw_slider.setValue(int(self._get_value("yaw_threshold", 15.0)))
        ...
        self._yaw_value_label = QLabel(f"{self._get_value('yaw_threshold', 15.0):.0f}°")
        ...
        self._roll_slider.setValue(int(self._get_value("roll_threshold", 10.0)))
        ...
        self._roll_value_label = QLabel(f"{self._get_value('roll_threshold', 10.0):.0f}°")
        roll_layout.addWidget(self._roll_slider)
        roll_layout.addWidget(self._roll_value_label)
        self._form_layout.addRow("翻滚阈值", roll_layout)
